package com.promeritage.maven.controller;
...
import com.promeritage.maven.base.BaseController;
...
import com.promeritage.maven.common.vo.ResponseVO;
import com.promeritage.maven.common.vo.form.EmployeeVO;
import com.promeritage.maven.entity.Employee;
import com.promeritage.maven.exception.LogicException;
...
public class MavenDemoController extends BaseController{
	...
	public @ResponseBody ResponseVO employeeNew(HttpServletRequest request, @RequestBody @Valid EmployeeVO requestVO, 
	...
	public @ResponseBody ResponseVO employeeUpdate(HttpServletRequest request, @RequestBody @Valid EmployeeVO requestVO, 
			BindingResult result) throws Exception{
		ResponseVO responseVO = new ResponseVO();
